...
def login():
  ...
  if request.method == "POST":
    ...
    return render_template("login.html",message = "User Not Fund")

@app.route("/post_number_detail/<int:post_id>")
def post_detail(post_id):
    ...
    return render_template("detail_post.html", message = message, comment_list = comment_list)
